...
// FactionExporterV2 handles exporting faction data to the new Phase 1.5 structure
type FactionExporterV2 struct {
	OutputDir string
	Loader    *loader.Loader
	Verbose   bool
}

// NewFactionExporterV2 creates a new Phase 1.5 faction exporter
func NewFactionExporterV2(outputDir string, l *loader.Loader, verbose bool) *FactionExporterV2 {
	return &FactionExporterV2{
		OutputDir: outputDir,
		Loader:    l,
		Verbose:   verbose,
	}
...
// ExportFactionV2 exports a faction using the new Phase 1.5 structure
func (e *FactionExporterV2) ExportFactionV2(metadata models.FactionMetadata, units []models.Unit) error {
...
func (e *FactionExporterV2) exportUnits(unitsDir string, units []models.Unit) (*models.FactionIndex, error) {
...
func (e *FactionExporterV2) copyFile(fileInfo *loader.UnitFileInfo, destDir string) error {
...
func (e *FactionExporterV2) copyFromZip(fileInfo *loader.UnitFileInfo, destPath string) error {
...
func (e *FactionExporterV2) copyFromFilesystem(srcPath, destPath string) error {
...
func (e *FactionExporterV2) writeMetadata(factionDir string, metadata models.FactionMetadata) error {
...
func (e *FactionExporterV2) writeIndex(factionDir string, index *models.FactionIndex) error {
