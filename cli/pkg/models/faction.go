...
type UnitIndexEntry struct {
	...
	ResolvedFile string     `json:"resolvedFile,omitempty" jsonschema:"description=Filename of the resolved unit specification with base_spec inheritance merged and all calculations complete (e.g. tank_resolved.json). This file contains the complete parsed Unit object ready for consumption by the web app."`
}
